class RegistrationController < ApplicationController
  ...
  def edit_profile
    mixpanel.track("Contact info requested", :distinct_id => current_user.hashed_id)
  ...
  def update_profile
    ...
    if params[:user]
      if @user.update_attributes(params[:user])
        ...
        mixpanel.track("Confirmation email sent", :distinct_id => @user.hashed_id)
  ...
  def payment
    mixpanel.track("Payment requested", :distinct_id => current_user.hashed_id)
  ...
  def create_payment
    ...
    begin
      ...
      mixpanel.track("Payment complete", :distinct_id => current_user.hashed_id)
